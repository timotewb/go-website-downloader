...
// 		// Define srv at a higher scope level
// 		var srv *http.Server
...
// 		}
// 		// Start the HTTP server in a non-blocking manner
// 		go func() {
// 			// Listen and serve on the specified address
// 			if err := srv.ListenAndServe(); err != nil && err != http.ErrServerClosed {
// 				log.Printf("error from RunWebServer(): ListenAndServe(): %v\n", err)
// 			}
// 		}()
